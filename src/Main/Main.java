...
public class Main {
	public static void main(String [] args) {
        ...
        Carrefour i1=new Carrefour(engine, githubCity, CarrefourNames.I1, new FeuRougeCroises(engine,10,10));
        ...
        Carrefour i2=new Carrefour(engine, githubCity, CarrefourNames.I2, new FeuRougeCroises(engine,12,8));
