...
public  class Voiture extends SimEntity implements IRecordable {
     ...
     * J'aime pas l'idée actuelle de la conception : à savoir que le goto chaine infiniement avec le isArrived
     * Il faudrait plutôt ça comme event :
     *  - ArriveToQueue
     *      On arrive dans la file du carrefour, ne dÃ©clenche aucun évenements.
     *  - CrossCarrefour
    ...
    public class CrossCarrefour extends SimEvent {
			...
			public void process() {
				...
				//La voiture déclenche l'évenemenement pour se déplacer au carrefour suivant.
